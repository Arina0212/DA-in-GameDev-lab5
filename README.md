...
## Постановка задачи.
В данной лабораторной работе мы в проекте Unity рализуем интеграцию экономической системы в проект Unity и обучение ML-Agent. А также наглядно увидим от каких параметров .yaml файла зависит обучение с помощью TensorBoard
